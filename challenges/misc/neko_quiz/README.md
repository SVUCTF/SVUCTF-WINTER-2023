...
有个选手，开赛一分钟就提交 Flag 了，见[花絮-抢跑](../../../behind-the-scenes/README.md#%E6%8A%A2%E8%B7%91)。

猜测是早几天看见了我仓库里正在写的 NekoQuiz 框架，其中示例用的就是此次比赛的题目。

是有意设为公共仓库的，想着反正是搜索类题目，有谁愿意时不时逛逛 GitHub 找到了也好，反正只有题目没传答案，能接受的解法。
